...
class mainframe extends JFrame implements ActionListener, Runnable {
	...
	AudioStream as;
	Thread t;
	private static final String DEFAULT_PATH = "E:\\pop8.wav";
	...
	public mainframe() throws Exception {
		...
		Bplay.setBounds(72, 200, 64, 25);
		Bstop.setBounds(146, 200, 64, 25);
		Bopen.setBounds(220, 200, 62, 25);
		Bsave.setBounds(292, 200, 80, 25);
	...
	public void Audioencrypt(String message, File file, int key) throws Exception {
		byte b[] = new byte[1];
		BigInteger Abi, Mbi;
		int k, k1;
		InputStream ins = new FileInputStream(file);
		OutputStream outs = new FileOutputStream(new File(DEFAULT_PATH));
		for (int c = 0; c < key; c++) {
			int ch = ins.read();
			outs.write(ch);
		}
