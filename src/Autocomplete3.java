...
public class Autocomplete3 implements DocumentListener {
	...
	public Autocomplete3(JTextField textField, List<String> keywords) {
		this.textField = textField;
		Autocomplete3.keywords = keywords;
	...
	public static void main(String args[]) {
		...
		keywords.add("java");
		Autocomplete3 autoComplete = new Autocomplete3(mainTextField, keywords);
